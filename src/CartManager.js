...
// const cm = new CartManager("./src/carts.txt", "./src/products.txt");
// console.dir(await cm.getCarts(),{depth:null})
// console.log(await cm.createCart());
// console.dir(await cm.getCarts(),{depth:null})
// console.log(await cm.addProduct(1, 2, 5));
// console.log(await cm.addProduct(1, 4, 2));
// console.dir(await cm.getCarts(),{depth:null})
// console.log(await cm.addProduct(1, 55, 5));
// console.log(await cm.addProduct(5, 2, 5));
